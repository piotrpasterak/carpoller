...
exports.defineAutoTests = function() {
  ...
  var isWindowsStore =
    cordova.platformId === 'windows8' || (cordova.platformId === 'windows' && !WinJS.Utilities.isPhone); // eslint-disable-line no-undef
...
exports.defineManualTests = function(contentEl, createActionButton) {
  ...
  var location_div =
    '<div id="info">' + '<b>Status:</b> <span id="location_status">Stopped</span>' + '<table width="100%">';
  var latitude =
    '<tr>' +
    '<td><b>Latitude:</b></td>' +
    '<td id="latitude">&nbsp;</td>' +

...
- **geolocationError** : _(facultative)_ la fonction callback s'exécutant si une erreur survient.

- **geolocationOptions** : _(facultatives)_ des préférences de géolocalisation.
...
- **coords** : un ensemble de coordonnées géographiques. _(Coordinates)_

- **timestamp** : horodatage de la création de `coords`. _(DOMTimeStamp)_
...
- **latitude** : latitude en degrés décimaux. _(Number)_

- **longitude** : longitude en degrés décimaux. _(Number)_

- **altitude** : hauteur de la position en mètres au-dessus de l'ellipsoïde. _(Number)_

- **accuracy** : niveau de précision des valeurs de latitude et longitude, en mètres. _(Number)_

- **altitudeAccuracy** : niveau de précision de la valeur d'altitude, en mètres. _(Number)_

- **heading** : direction du trajet, indiquée en degrés comptés dans le sens horaire par rapport au vrai Nord. _(Number)_

- **speed** : vitesse au sol actuelle de l'appareil, indiquée en mètres par seconde. _(Number)_

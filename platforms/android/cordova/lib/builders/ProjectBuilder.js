...
class ProjectBuilder {
  ...
  readProjectProperties() {
    ...
    return {
      libs: findAllUniq(data, /^\s*android\.library\.reference\.\d+=(.*)(?:\s|$)/gm),
      gradleIncludes: findAllUniq(data, /^\s*cordova\.gradle\.include\.\d+=(.*)(?:\s|$)/gm),
      systemLibs: findAllUniq(data, /^\s*cordova\.system\.library\.\d+=(.*)(?:\s|$)/gm)
    };
  }
